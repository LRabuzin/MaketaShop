\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\noindent \underbar{\textbf{UC21 - Omogućavanje prodaje jedinstvene makete iz priče}}
					\begin{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator pritišće gumb za uklanjanje pojedine makete
							\item Maketa je uklonjena iz web trgovine
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: } Registrirani korisnik
						\item  \textbf{Cilj:} Ocijeniti maketu
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Postojanje makete
						\item  \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							\item Korisnik detaljno pregledava maketu
							\item Korisnik odabire ocjenu pritiskom na nju
							\item Ažurira se prikaz ocjena na maketi
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: } Administrator
						\item  \textbf{Cilj:} Pregledati koji korisnik je kako ocjenio priču
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Nema
						\item  \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							\item Administrator detaljno pregledava priču
							\item Administrator odabire gumb za pregled ocjena
							\item Administratoru su prikazana sva korisnička imena korisnika koji su ocijenili priču i pokraj njih ocjena koju su dali
						\end{packed_enum}
