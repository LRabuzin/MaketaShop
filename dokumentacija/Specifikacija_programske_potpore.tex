\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\noindent \underbar{\textbf{UC20 - Komentiranje priče}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC30 - Naručivanje custom makete ispunjavanjem formulara}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC34 - Uređivanje makete u web trgovini}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: } Administrator
						\item  \textbf{Cilj:} Urediti maketu u web-trgovini
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Biti administrator, postojanje makete u web-trgovini
						\item  \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							
							\item Pritisak na gumb uredi
							\item Obavljanje potrebnih promjena
							\item Spremanje promjena u bazi podataka pritiskom na gumb
						\end{packed_enum}
					...
					\noindent \underbar{\textbf{UC38 - Prihvaćanje ili odbijanje cijene za custom maketu}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: } Administrator
						\item  \textbf{Cilj:} Davanje povratne informacije administratoru je li prihvaćena njegova cijena ili ne
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Biti administrator, inicijaliziran je postupak naručivanja custom makete, korisnik je poslao skicu, a administrator je kreirao cijenu
						\item  \textbf{Opis osnovnog tijeka:}
